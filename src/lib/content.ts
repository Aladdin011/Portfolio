...
export const TIMELINE = [
  {
    // TODO(confirm): Confirm the JD Marc title; the résumé and current site conflict.
    // TODO(confirm): Confirm whether the start date is July 2025 or 05/2025.
  ...
  {
    // TODO(confirm): Confirm whether this was a paid role or a six-month mandatory
    // internship; those employment types require different dates and wording.
